/* T01-S1 · "Nugget" — skala jarak antar tingkat memori, dibuat manusiawi.
   ...
   Daftar scene          : ideas/apa-itu-ram/naskah.md § Short 1
  ...
  <Panggung rasio="9x16">
    {TIMING.map((t) => {
      /* Batas frame dihitung dari titik MULAI dua scene berurutan, bukan dari
         ...
         lebih mahal daripada di video panjang: ia jatuh di tengah 50 detik yang
