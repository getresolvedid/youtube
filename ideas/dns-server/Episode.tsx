...
import { FigurLoket } from "./scenes/02-opening";
import { TIMING, type Timing } from "./timing.gen";

/** Judul episode, tampil di kartu pembuka (docs/10).
 *
 *  Kartu ini tayang di sekitar detik 19, sementara VO baru menamai loketnya di
 *  `05-loket` (~detik 82) — dan itu DISENGAJA. Yang dilarang HARD RULE 6 adalah
 *  VO yang menyebut nama sebelum bendanya berdiri, bukan kartu judulnya. Karena
 *  itu penamaan di scene 5 ditulis sebagai penegasan ("ya, loket itu namanya
 *  D N S server"), bukan sebagai perkenalan — dan tidak ada satu pun scene yang
 *  mengeja kepanjangannya lewat VO. Kepanjangan itu tugas kartu ini, sekali,
 *  tanpa suara. */
...
export const isiScene = (t: Timing): React.ReactNode => {
  ...
  if (t.id === "opening")
    return <KartuJudul judul={JUDUL} subjudul={SUBJUDUL} figur={<FigurLoket />} />;
