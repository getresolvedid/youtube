/* T01-S2 · "Jebakan" — "RAM lebih besar pasti bikin komputer lebih cepat".
   ...
   Daftar scene          : ideas/apa-itu-ram/naskah.md § Short 2
   ...
   Bentuknya identik dengan s1-nugget/Short.tsx dan itu disengaja: dua Short dari
   topik yang sama tayang berdekatan (docs/06 — S1 hari H, S2 hari H+3), dan
   perangkai yang berbeda akan pelan-pelan melahirkan dua gaya penutup.

   Tidak ada kartu judul: Shorts tanpa intro brand, logo cuma di 2 detik terakhir.
*/
