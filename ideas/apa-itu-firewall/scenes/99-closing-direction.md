Anggaran: mulai 380,48 dtk · durasi `CLOSING_LONG_SECONDS` (dari .env).
...
catatan:
   - **frame terakhir sebelum scene ini adalah GAMBAR, bukan teks**: satu pintu
     menyala di dinding yang gelap (`15-diundang-masuk`, tahap 11). Potongan ke
     tanda brand terjadi dari gambar yang sudah tenang, bukan dari gerakan.
   - **satu-satunya ajakan berlangganan di seluruh episode ada di sini**
     ...
     dan `15-diundang-masuk` sengaja berakhir tanpa permintaan apa pun.
