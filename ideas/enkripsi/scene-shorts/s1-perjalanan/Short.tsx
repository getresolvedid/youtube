/* T17-S1 · "Apa yang terjadi pada pesanmu?" — 9:16
   ...
   TIGA BEDANYA DARI Episode.tsx, dan ketiganya datang dari docs/02:
     ...
     1. TIDAK ADA OPENING. Shorts tanpa intro brand — logo cuma muncul di 2 detik
        penutup. `tools/baca-episode.mjs` yang memastikannya: `bacaShort()` tidak
        pernah menyisipkan scene `opening`.
     2. Closing memakai `CLOSING_SHORT_SECONDS` (2 dtk), bukan yang 5 dtik.
