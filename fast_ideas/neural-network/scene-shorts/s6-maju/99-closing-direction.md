...
tidak didaftarkan di `SCENES`, tidak punya rencana VO. Durasi dari
`CLOSING_SHORT_SECONDS`.

**Frame pertamanya = frame terakhir `6-berikutnya`:** kartu tebakan + tanda
tanya, lalu potong keras ke kartu penutup.
